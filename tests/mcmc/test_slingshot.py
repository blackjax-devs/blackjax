...
import blackjax
from blackjax.mcmc.slingshot import SlingshotInfo, SlingshotState
...
class SlingshotTest(BlackJAXTest):
    def test_protocol_conformance(self):
        ...
        algo = blackjax.slingshot(
            std_normal_logdensity, step_size=0.5, num_proposals=10
        )
    ...
    def test_slingshot_parameter_recovery(self):
        ...
        algo = blackjax.slingshot(
            std_normal_logdensity, step_size=0.5, num_proposals=1000
        )
