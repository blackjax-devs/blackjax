...
def benchmark_mhmchmc(batch_size):
    ...
    for model, coeffs in itertools.product(models, coefficients):
        ...
        if True:
            ...
            print(
                f"params after initial tuning are L={blackjax_mhmclmc_sampler_params.L}, step_size={blackjax_mhmclmc_sampler_params.step_size}"
            )
            ...
            L, step_size, convergence = gridsearch_tune(
                ...
                batch=num_chains,
                num_steps=num_steps,
                center_L=blackjax_mhmclmc_sampler_params.L,
                center_step_size=blackjax_mhmclmc_sampler_params.step_size,
            )
