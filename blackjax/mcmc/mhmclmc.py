...
from blackjax.mcmc.hmc import DynamicHMCState, HMCInfo, HMCState
...
#     time_step: float # time step (0., 1., 2., ....)
#     position: Array # location in the sampling space
#     logdensity: float # - log p(x)
#     grad_logdensity: Array # - grad log p(x)
